...
class Tools
{
     ...
     * @return string
     */
    public static  function getSysRandName(){
    ...
    public static  function  checkToken()
    {
        ...
        //校验token签名
        try {
            $signFlag = JwtAuth::getInstance()->setToken($token)->verify();
            if (!$signFlag) {
                return  40003;
            }
        } catch (\Exception $e) {
        ...
        //校验token是否失效
        $tokenFlag = JwtAuth::getInstance()->setToken($token)->valiDate();
